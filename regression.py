...
with open('label_encoder_reg.pkl','rb') as file:
    label_encoder_gender=pickle.load(file)
with open('onehot_encoder_reg.pkl','rb') as file:
...
salary=model.predict(input_data_scaled)

st.write(f"Predicted Salary: {salary[0][0]}")
